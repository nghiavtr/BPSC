...
\title{User guide for $BPSC$ package version 0.99.1}
...
<<Example_fig1b_BP4, out.width='4.5in',fig.align='center', tidy=FALSE,message=F, warning=F, echo=FALSE>>=
library(BPSC)
...
@
\begin{scriptsize}
The figure is produced by the data generated from the four-parameter beta-Poisson model in figure 1 of our recent study [1]: alp=0.2160247, bet=0.5989889, lam1=171.9596728, lam2=0.9094114
\end{scriptsize}
